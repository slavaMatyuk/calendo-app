...
const EventForm: FC<EventFormProps> = (props) => {
  ...
  return (
    <Form onFinish={submitForm}>
      ...
      <Form.Item label='Дата события' name='date' rules={[rules.required(), rules.isDateInFuture('Невозможно создать событиые в прошлом')]}>
        <DatePicker onChange={date => selectDate(date)} />
      </Form.Item>
      <Form.Item label='Выберите участника' name='guest' rules={[rules.required()]}>
